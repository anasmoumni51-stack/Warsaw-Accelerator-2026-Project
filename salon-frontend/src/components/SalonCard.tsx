    ...
    <div className="bg-canvas border-[0.10px] border-hairline rounded-[14px] hover:border-primary hover:border transition-[border-color] duration-200 flex flex-col md:flex-row">
      ...
      <div className="flex-1 min-w-0 p-3 md:p-3 flex flex-col justify-between">
          ...
          <div className="flex justify-between items-start gap-2 mb-2 md:mb-3">
            ...
            <span className="font-body text-[12px] font-medium text-muted whitespace-nowrap">{salon.priceRange}</span>
          </div>

          {/* Rating row */}
          <div className="flex items-center gap-3 mb-2 md:mb-3">
            <div className="flex items-center gap-1">
              <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 24" fill="#E8385C" stroke="#E8385C" strokeWidth="2">
                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
              </svg>
              <span className="font-body text-[13px] font-semibold text-ink">{salon.rating}</span>
              <span className="font-body text-[13px] text-muted">({salon.reviewCount})</span>
            </div>
            ...
            <div className="hidden md:flex flex-wrap gap-4">
              {salon.services.slice(0, 2).map((service) => (
                <div key={service} className="flex items-center gap-1 text-ink">
                  <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#E8385C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
